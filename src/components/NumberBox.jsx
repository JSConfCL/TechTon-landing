export const NumberBox = ({ number, text, flip }) => {
  return (
    <div className="flex flex-col items-center mt-4">
      <div className="relative bg-transparent flex flex-col items-center justify-center rounded-lg w-16 h-16 sm:w-20 sm:h-24 md:w-28 md:h-32 mt-4 ">
      ...
      <p className="text-sm mt-3 font-bold text-white md:text-2xl ">{text}</p>
    </div>
  );
};
