...
export default function Nosotros() {
  return (
    <section className="flex flex-col items-center justify-between mx-auto md:px-10 gap-8">
      <Title
        logo={
          <svg
            aria-label="TechTon"
      ...
      <div className="flex flex-col items-center justify-center gap-4 lg:flex-row">
        <div className="py-10 md:space-y-10 space-y-5">
          ...
          <div className="space-y-4 font-light leading-7 text-left text-sm md:text-lg">
            ...
            brindaremos charlas y sesiones de QA gratuitas mediante streaming
            para recaudar fondos que serán entregados a{" "}
            <a
            ...
            y asi poder ayudar a mitigar los efectos causados por los incendios
            forestales que comenzaron a ocurrir el 2 de febrero recién pasado,
